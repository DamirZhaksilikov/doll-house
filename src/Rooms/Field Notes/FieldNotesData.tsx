...
export class FieldNotesData {
    ...
    public static FieldNotesLinks = [
      ...
      {
        id: FieldNotesData.FieldNotesIds.workNotes,
        isDoor: false,
        isBehindDoor: false,
      ...
      {
        id: FieldNotesData.FieldNotesIds.personalEssays,
        isDoor: false,
        isBehindDoor: false,
      ...
      {
        id: FieldNotesData.FieldNotesIds.recRoom,
        isDoor: true,
        isBehindDoor: false,
      }
