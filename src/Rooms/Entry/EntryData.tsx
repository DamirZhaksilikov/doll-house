...
export class EntryData {
    ...
    public static EntryRoomLinks = [
      {
        ...
        isDoor: false,
        isBehindDoor: false,
        id: EntryData.EntryRoomIds.siteInfo
      },
      {
        isDoor: true,
        isBehindDoor: false,
        id: EntryData.EntryRoomIds.recRoom
      },
      {
        isDoor: true,
        isBehindDoor: false,
      ...
      },
      {
        isDoor: true,
        isBehindDoor: false,
        id: EntryData.EntryRoomIds.mailRoom
      }
    ...
    public static MapCoordinates = { 
      name: "entryMap",
      areas: [
        { name: EntryData.EntryRoomIds.siteInfo, shape: "rect", coords: [1388,480,1656,688]},
        { name: EntryData.EntryRoomIds.recRoom, shape: "rect", coords: [1096,410,1281,813]},
